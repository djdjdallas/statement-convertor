              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    We support PDF bank statements from over 200 banks
                    worldwide. Our AI can handle both native PDFs and scanned
                    documents.
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    ...
                    business days. Premium customers receive priority support
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600">
                    Phone support is available for Business and Enterprise
                    customers during business hours. All customers can reach us
                    via email and chat support.
                  </p>
                </div>
              </div>
            </div>
